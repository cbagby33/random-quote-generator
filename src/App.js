...
const quotes = Array.from(data); // parse JSON data

// randomly choose a shade of brown to display
...
// randomly choose a quote to display
...
class QuoteBox extends React.Component {
  ...
  // Choose random quote on initial load of component  
  componentDidMount() {
